# -*- coding: utf-8 -*-
"""Build Microsoft Azure Certification Guide blog from docx and wire site-wide."""
...
SLUG = "microsoft-azure-certification-guide"
VANITY_PATH = "/azure-certification-guide"
IMG_SLUG = "microsoft-azure-certification-guide"
META_TITLE = "Microsoft Azure Certification Guide 2026 | Nexperts Academy"
META_DESC = (
    "Explore the Microsoft Azure Certification Guide for beginners, including "
    "AZ-900, AZ-104, AZ-305, certification paths, career goals, and training tips."
)
DOCX = ROOT / "Microsoft Azure Certification.docx"
IMG_DIR = ROOT / "image" / "blog" / IMG_SLUG
AZ900 = "/courses/az-900"
AZ104 = "/courses/az-104"
AZ305 = "/courses/az-305"
AZ204 = "/courses/az-204"
AZ400 = "/courses/az-400"
AZ500 = "/courses/az-500"
DP203 = "/courses/dp-203"
DP300 = "/courses/dp-300"
...
SKIP_LINES = {
    ...
    META_TITLE.lower(),
    META_DESC.lower(),
    "https://www.nexpertsacademy.com/blog/microsoft-azure-certification-guide/",
    "https://www.nexpertsacademy.com/blog/microsoft-azure-certification-guide",
    VANITY_PATH,
    f"{VANITY_PATH}/",
    f"/blog/{SLUG}/",
...
def _should_skip(plain: str) -> bool:
    ...
    if key.startswith("meta description"):
        return True
        if key.startswith("h1") and "azure" in key:
            return True
        return False
...
def _youtube_embed(url: str) -> str:
    ...
    return (
        ...
        f'<iframe src="https://www.youtube.com/embed/{vid}" title="Microsoft Azure certification overview" '
...
def docx_to_body(docx_path: Path) -> tuple[str, list[tuple[str, str]], str]:
    ...
    list_buf: list[str] = []
    title = "Microsoft Azure Certification Guide for Beginners"
    h2_counter = 0
    in_faq = False
    ...
    for child in body_el:
            ...
            for blip in drawing.iter(f"{A}blip"):
                ...
                if rid and rid in rel_map:
                    ...
                    blocks.append(
                        ...
                        f'alt="Microsoft Azure certification roadmap and exam path" loading="lazy" '
        ...
        if plain.lower().startswith("microsoft azure certification guide") and style in (
            "Heading1",
            "",
        ):
...
def _apply_links(body: str) -> str:
    replacements = [
        (
            ...
            f'<a href="{AZ900}">AZ-900: Microsoft Azure Fundamentals</a>',
        ),
        (
            "AZ-104: Microsoft Azure Administrator Associate",
            f'<a href="{AZ104}">AZ-104: Microsoft Azure Administrator Associate</a>',
        ),
        (
            "AZ-305 exam",
            f'<a href="{AZ305}">AZ-305 exam</a>',
        ),
        (
            "Azure Developer Associate",
            f'<a href="{AZ204}">Azure Developer Associate</a>',
        ),
        (
            "Azure Data Engineer",
            f'<a href="{DP203}">Azure Data Engineer</a>',
        ),
        (
            "Azure Database Administrator",
            f'<a href="{DP300}">Azure Database Administrator</a>',
        ),
        (
            "azure certification training",
            f'<a href="{AZ900}">Azure certification training</a>',
        ),
        (
            "azure certification courses",
            f'<a href="{AZ104}">Azure certification courses</a>',
        ),
        (
            "AWS training",
            '<a href="/blog/aws-certification-roadmap">AWS training</a>',
        ),
        (
            "Networking courses",
            '<a href="/ccna">Networking courses</a>',
        ),
        (
            "DevOps programs",
            f'<a href="{AZ400}">DevOps programs</a>',
        ),
        (
            "Cybersecurity courses",
            '<a href="/ceh">Cybersecurity courses</a>',
        ),
        (
            "Nexperts Academy",
        ...
        (
            "AZ-900",
            f'<a href="{AZ900}">AZ-900</a>',
        ),
        (
            "AZ-104",
            f'<a href="{AZ104}">AZ-104</a>',
        ),
        (
            "AZ-305",
            f'<a href="{AZ305}">AZ-305</a>',
        ),
    ]
    ...
    body = body.replace(
        "highly valued by employers across the United States",
        "highly valued by employers in Malaysia and globally",
    )
...
def patch_sitemap() -> None:
    ...
    if SLUG not in text:
        anchor = f"  <url><loc>{SITE}/blog/fortinet-certification-guide</loc>"
        if anchor in text:
...
def patch_blog_index() -> None:
    ...
    text = path.read_text(encoding="utf-8")
    link = (
        f'      <a href="/blog/{SLUG}">Microsoft Azure Certification Guide 2026 | Nexperts Academy '
        f"<span>Cloud · Aug 2026</span></a>\n"
    )
    if f'href="/blog/{SLUG}"' not in text.split("Latest posts", 1)[-1].split(
        "Featured", 1
    )[0]:
        for marker in (
            '      <a href="/blog/fortinet-certification-guide">',
    ...
    card = f"""      <a class="card" href="/blog/{SLUG}">
        <h3>Microsoft Azure Certification Guide</h3>
        <p>Beginner Azure roadmap — AZ-900, AZ-104, AZ-305, career paths and exam prep for 2026.</p>
        <span class="card-link">Read article →</span>
      </a>
"""
    if f'<a class="card" href="/blog/{SLUG}">' not in text:
        for marker in (
            '      <a class="card" href="/blog/fortinet-certification-guide">',
            ...
            if marker in text:
                ...
                break
    menu_link = (
        f'        <a href="/blog/{SLUG}" role="menuitem">Microsoft Azure Certification Guide 2026</a>\n'
    )
    if f'href="/blog/{SLUG}"' not in text.split("nav-addons-col-title\">Blog", 1)[-1][
        :900
    ]:
        marker = '        <a href="/blog/fortinet-certification-guide" role="menuitem">Fortinet Certification Guide 2026</a>'
        if marker in text:
...
{nav}
<section class="hero">
  <p style="font-size:.72rem;color:var(--ink3);margin-bottom:14px"><a href="/" style="color:inherit;text-decoration:none">Home</a> / <a href="/blog" style="color:inherit;text-decoration:none">Blog</a> / Microsoft Azure Certification Guide</p>
  <h1>Microsoft Azure Certification Guide<br><em>Beginner roadmap for 2026</em></h1>
  <p>August 2026 · Nexperts Cloud Practice</p>
</section>
...
{body_html}
    <div class="card-grid">
      <a class="card" href="{AZ900}">
        <h3>AZ-900 Azure Fundamentals</h3>
        <p>Beginner Microsoft Azure cloud concepts, services, security and pricing training in Malaysia.</p>
        <span class="card-link">Learn more →</span>
      </a>
      <a class="card" href="{AZ104}">
        <h3>AZ-104 Azure Administrator</h3>
        <p>Hands-on identity, compute, networking and operations for associate-level Azure roles.</p>
        <span class="card-link">Learn more →</span>
      </a>
  ...
  <p style="margin-top:2rem"><a href="/contact-us#enquire" style="color:var(--blue);font-weight:700">Enquire about Azure certification training →</a></p>
</section>
<footer>
